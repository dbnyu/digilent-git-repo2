...
dwf.FDwfAnalogInRecordLengthSet(hdwf, c_double(1)) # sets record length in seconds. length of 0 is infinite record length 
...
ax.plot(np.fromiter(rgdSamples, dtype = np.float))
