...
% arbitrarily selected square pulse examples:
files = {'20220104-144340_red2blueSquare1H_data.csv', ...
		 '20220104-144447_red2blueSquare1Ms_data.csv', ...
		 %'20220104-150117_red2blueSquare1H2p5V_data.csv' ...		% TODO change 2nd underscore
		 };
% TODO try windowed Fourier of echos - seems like 0.5usec has more 1Mhz content, and 1usec has lower freq content...
%	ie. distance (mm) = [1250 ... 1350] (need to translate this to indexes probably)


% arbitrary sine wave examples:
%files = {'20220104-145014_red2blueSine10x_data.csv', ...	% 10 cycles
%		 '20220104-145107_red2blueSine3x_data.csv', ...		% 3 cycles
%		 %'20220104-145330_red2blueSine1x_data.csv', ...		% 1 cycle
%		 };


%files = {%'20220104-144201_red2blueSquare1H_data.csv', ...
%		 %'20220104-144246_red2blueSquare1H_data.csv', ...
%		 %'20220104-144335_red2blueSquare1H_data.csv', ...
%		 '20220104-144340_red2blueSquare1H_data.csv', ...
%		 %'20220104-144423_red2blueSquare1Ms_data.csv', ...
%		 %'20220104-144441_red2blueSquare1Ms_data.csv', ...
%		 '20220104-144447_red2blueSquare1Ms_data.csv', ...
%		 %'20220104-144503_red2blueSquare1MsTouchWires_data.csv', ...
%		 %'20220104-144536_red2blueSquare1MsTouchRedTdxCloth_data.csv', ...
%		 %'20220104-144830_red2blueSine10x_data.csv', ...
%		 %'20220104-144857_red2blueSine10x_data.csv', ...
%		 %'20220104-144921_red2blueSine10x_data.csv', ...
%		 %'20220104-144936_red2blueSine10x_data.csv', ...
%		 %'20220104-145004_red2blueSine10x_data.csv', ...
%		 %'20220104-145009_red2blueSine10x_data.csv', ...
%		 '20220104-145014_red2blueSine10x_data.csv', ...
%		 %'20220104-145042_red2blueSine3x_data.csv', ...
%		 %'20220104-145057_red2blueSine3x_data.csv', ...
%		 %'20220104-145103_red2blueSine3x_data.csv', ...
%		 '20220104-145107_red2blueSine3x_data.csv', ...
%		 %'20220104-145123_red2blueSine1x_data.csv', ...
%		 %'20220104-145129_red2blueSine1x_data.csv', ...
%		 %'20220104-145144_red2blueSine1x_data.csv', ...
%		 %'20220104-145148_red2blueSine1x_data.csv', ...
%		 '20220104-145330_red2blueSine1x_data.csv', ...
%		 %'20220104-150012_red2blueSquare1HDECREASING_data.csv', ...
%		 '20220104-150117_red2blueSquare1H2p5V_data.csv' ...		% TODO change 2nd underscore
%		 };
